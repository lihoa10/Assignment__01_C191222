...
function calculateBudget() {
    let totalIncomeValue = parseFloat(totalIncome.innerHTML.replace(/,/g, ""));
    let totalExpenseValue = parseFloat(totalExpense.innerHTML.replace(/,/g, ""));
    let remainingBudget = totalIncomeValue - totalExpenseValue;
    totalBudget.innerHTML = formatMoney(remainingBudget);
}
calculateBudget();
